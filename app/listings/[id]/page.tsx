          ...
          <div className="lg:col-span-2 bg-white p-8 rounded-xl border border-neutral-200/80">
            ...
            <section className="mt-8">
              ...
              <div className="grid grid-cols-2 gap-4 text-neutral-700">
                ...
                {(listing.listingType === "PG" ||
                  ...
                  listing.bedsPerRoom && (
                    <div className="flex items-center gap-2">
                      ...
                      <p>
                        {listing.bedsPerRoom} beds total,{" "}
                        {listing.availableBeds} available
                      </p>
                    </div>
                  )}
                ...
                <div className="flex items-center gap-2">
                  <span className="font-semibold">Electricity:</span> Bill paid
                  by {listing.electricityBillBy}
                </div>
              </div>
            </section>
            ...
            <div className="sticky top-24 bg-white p-6 rounded-xl shadow-lg border border-neutral-200/80">
              ...
              <div className="mt-6 space-y-3 border-t pt-4">
                <p className="font-semibold text-neutral-700">
                  Contact Person: {listing.contact.name}
                </p>
                <a
                  href={`tel:${listing.contact.phone}`}
                  className="w-full flex items-center justify-center py-3 px-4 rounded-lg text-lg font-semibold text-white bg-teal-600 hover:bg-teal-700 transition"
                >
                ...
                {listing.contact.email && (
                  <a
                    ...
                    className="w-full flex items-center justify-center py-3 px-4 rounded-lg text-lg font-semibold text-teal-700 bg-teal-50 hover:bg-teal-100 transition"
                  >
